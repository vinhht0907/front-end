<template>
  <b-modal
    ...
    :title="isEdit ? 'Sửa danh mục luyện nghe' : 'Thêm danh mục luyện nghe'"
  ...
  methods: {
    ...
    async addItem() {
      try {
        ...
        await this.vForm.post(
          this.$axios.defaults.baseURL + '/listening-category/add'
        )

        notifyAddSuccess('Danh mục danh mục')
    ...
    async updateItem() {
      try {
        this.vForm = new Form(this.form)
        await this.vForm.post(
          this.$axios.defaults.baseURL + '/listening-category/edit'
        )

        notifyUpdateSuccess('Danh mục danh mục')
        this.$refs.modal.hide()
        this.onActionSuccess()
      } catch (e) {
        if (e.response) {
