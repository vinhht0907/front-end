    ...
    <div class="form-group m-form__group">
      ...
      <perfect-scrollbar class="inputSearchPermission">
        <div class="container-fluid row">
          <div v-for="item in filteredList" class="col-md-6" data-height="150">
  ...
  methods: {
    ...
    async addItem() {
      try {
        ...
        notifyAddSuccess(this.$t('role.role'))
    ...
    async updateItem() {
      try {
        ...
        await this.vForm.put(
          this.$axios.defaults.baseURL + '/role/' + this.form._id
        )

        notifyUpdateSuccess(this.$t('role.role'))
        await this.$auth.fetchUser()
        this.$refs.modal.hide()
        this.onActionSuccess()
      } catch (e) {
