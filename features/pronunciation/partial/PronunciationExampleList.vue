<template>
  <div class="list-collapse">
    <b-form-group label="Danh sách ví dụ" class="mb-2" label-class="required">
        ...
        >
          <transition-group type="transition" name="list-answer">
            ...
            >
              <template slot="title">
                <span
                  >Ví dụ {{ index + 1 }} / {{ innerValue.length }} -
    ...
    <b-button @click="addItem" block variant="primary" size="sm"
      ><i class="la la-plus"></i> Thêm ví dụ</b-button
    >
  </div>
</template>
...
import PronunciationExampleItem from './PronunciationExampleItem'

export default {
  name: 'PronunciationExampleList',
  components: {
