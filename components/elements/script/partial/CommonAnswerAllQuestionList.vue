        ...
        >
          <transition-group type="transition" name="list-answer">
            ...
            >
              ...
              <common-answer-all-question-single-choice
                v-if="answer.type === 'single_choice' || !answer.type"
                v-model="innerValue[index]"
                class="list-item-script__item mb-2 px-3 py-2"
              />
              <common-answer-all-question-multi-choice
...
import CommonAnswerAllQuestionMultiChoice from './CommonAnswerAllQuestionMultiChoice'
import CommonAnswerAllQuestionSingleChoice from './CommonAnswerAllQuestionSingleChoice'
...
export default {
  name: 'CommonAnswerAllQuestionList',
  components: {
    CommonAnswerAllQuestionSingleChoice,
    CommonAnswerAllQuestionMultiChoice,
    draggable
  },
  filters: {
    truncate(value) {
    ...
    typeLabel(value) {
      const item = options.find((o) => o.type === value)
      return item ? item.label : 'Single Choice'
    }
  },
  props: {
    value: {
