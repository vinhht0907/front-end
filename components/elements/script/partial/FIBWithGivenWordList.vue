...
import FIBWithGivenWordItem from '~/components/elements/script/partial/FIBWithGivenWordItem'

export default {
  name: 'FIBWithGivenWordList',
  components: {
    FIBWithGivenWordItem,
    draggable
  },
  filters: {
    truncate(value) {
