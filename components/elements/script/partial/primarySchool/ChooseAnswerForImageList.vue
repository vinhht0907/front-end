...
import ChooseAnswerForImageItem from '~/components/elements/script/partial/primarySchool/ChooseAnswerForImageItem'

export default {
  name: 'ChooseAnswerForImageList',
  components: {
    ChooseAnswerForImageItem,
    draggable
  },
  filters: {
    truncate(value) {
