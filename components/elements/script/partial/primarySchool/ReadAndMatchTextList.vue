...
import ReadAndMatchTextItem from '~/components/elements/script/partial/primarySchool/ReadAndMatchTextItem'

export default {
  name: 'ReadAndMatchTextList',
  components: {
