    ...
    <b-row>
      <b-col cols="6"
        ><validation-observer ref="observer" class="kt-form">
          <listen-and-number-item v-model="form.objects" />
        </validation-observer>
      </b-col>
      <b-col cols="6">
...
import ListenAndNumberItem from '~/components/elements/script/partial/primarySchool/ListenAndNumberItem'

const defaultForm = {
  objects: null
}
export default {
  name: 'ListenAndNumberModal',
  components: {
    FIBMultipartPreview,
    ValidationObserver,
    ListenAndNumberItem
