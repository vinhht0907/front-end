    ...
    <b-row>
      <b-col cols="6"
        ><validation-observer ref="observer" class="kt-form">
          <listen-and-check-list v-model="form.items" />
        </validation-observer>
      </b-col>
      <b-col cols="6">
...
import ListenAndCheckList from '~/components/elements/script/partial/primarySchool/ListenAndCheckList'

const defaultForm = {
  items: null
}
export default {
  name: 'ListenAndCheckModal',
  components: {
    ListenAndCheckList,
    FIBMultipartPreview,
    ValidationObserver
