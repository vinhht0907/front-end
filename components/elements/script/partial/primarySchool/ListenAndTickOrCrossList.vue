...
import ListenAndTickOrCrossItem from '~/components/elements/script/partial/primarySchool/ListenAndTickOrCrossItem'

export default {
  name: 'ListenAndTickOrCrossList',
  components: {
    ListenAndTickOrCrossItem,
    draggable
  },
  filters: {
    truncate(value) {
