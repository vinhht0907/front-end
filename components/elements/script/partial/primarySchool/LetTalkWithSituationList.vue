...
import LetTalkWithSituationItem from '~/components/elements/script/partial/primarySchool/LetTalkWithSituationItem'

export default {
  name: 'LetTalkWithSituationList',
  components: {
    LetTalkWithSituationItem,
    draggable
  },
  filters: {
    truncate(value) {
