<template>
  <div>
    ...
    <look-listen-repeat-sentence-object-modal
      ref="lookListenRepeatSentenceObjectModal"
      @submit="submitForm"
...
import LookListenRepeatSentenceObjectModal from '~/components/elements/script/partial/primarySchool/LookListenRepeatSentenceObjectModal'
...
export default {
  ...
  components: {
    LookListenRepeatSentenceObjectModal,
    ImageUploadBtn,
  ...
  methods: {
    ...
    showObjectModal(item = null) {
      if (this.innerValue.backgroundUrl !== '') {
        this.$refs.lookListenRepeatSentenceObjectModal.show(
