    ...
    <b-row>
      <b-col cols="6"
        ><validation-observer ref="observer" class="kt-form">
          <read-and-check-list v-model="form.items" />
        </validation-observer>
      </b-col>
      <b-col cols="6">
...
import ReadAndCheckList from '~/components/elements/script/partial/primarySchool/ReadAndCheckList'

const defaultForm = {
  items: null
}
export default {
  name: 'ReadAndCheckModal',
  components: {
    ReadAndCheckList,
    FIBMultipartPreview,
    ValidationObserver
