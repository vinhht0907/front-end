        ...
        >
          <transition-group type="transition" name="list-answer">
            ...
            >
              ...
              <look-listen-repeat-sentence-item
...
import LookListenRepeatSentenceItem from '~/components/elements/script/partial/primarySchool/LookListenRepeatSentenceItem'

export default {
  name: 'LookListenRepeatSentenceList',
  components: {
    LookListenRepeatSentenceItem,
    draggable
  },
  filters: {
    truncate(value) {
