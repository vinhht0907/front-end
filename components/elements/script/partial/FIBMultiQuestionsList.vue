...
import FIBMultiQuestionsItem from '~/components/elements/script/partial/FIBMultiQuestionsItem'

export default {
  name: 'FIBMultiQuestionsList',
  components: {
    FIBMultiQuestionsItem,
    draggable
  },
  filters: {
    truncate(value) {
