        ...
        >
          <transition-group type="transition" name="list-answer">
            ...
            >
              ...
              <match-expression-with-picture-item
...
import MatchExpressionWithPictureItem from '~/components/elements/script/partial/MatchExpressionWithPictureItem'

export default {
  name: 'MatchExpressWithPictureList',
  components: {
    MatchExpressionWithPictureItem,
    draggable
  },
  filters: {
    truncate(value) {
