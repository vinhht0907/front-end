<template>
  <div class="list-item-script">
    <el-collapse v-model="activeNames" class="content-mb-0">
      <draggable
        :list="innerValue"
      ...
      >
        <transition-group type="transition" name="list-answer">
          ...
          >
            ...
            <script-flashcard-attachment-item
...
import ScriptFlashcardAttachmentItem from './ScriptFlashcardAttachmentItem'

export default {
  name: 'ScriptFlashcardAttachmentList',
  components: {
    ScriptFlashcardAttachmentItem,
    draggable
  },
  filters: {
    truncate(value) {
