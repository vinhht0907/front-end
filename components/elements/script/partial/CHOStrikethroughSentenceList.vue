<template>
  <div class="list-item-script list-collapse">
        ...
        >
          <transition-group type="transition" name="list-answer">
            ...
            >
              ...
              <c-h-o-strikethrough-sentence-item
                v-model="innerValue[index]"
                class="list-item-script__item px-3 py-2"
              />
            </el-collapse-item>
          </transition-group>
        </draggable>
...
import CHOStrikethroughSentenceItem from '~/components/elements/script/partial/CHOStrikethroughSentenceItem'

export default {
  name: 'CHOStrikethroughSentenceList',
  components: {
    CHOStrikethroughSentenceItem,
    draggable
  },
  filters: {
    truncate(value) {
