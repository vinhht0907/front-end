<template>
  <b-modal
    ...
    cancel-title="Đóng"
    ok-title="Đồng ý"
    title="Speaking linking sound inline"
    size="xl"
  >
    <b-row>
      <b-col cols="7"
        ><validation-observer ref="observer" class="kt-form">
          ...
          <b-text-input-with-validation
            ...
            :required="true"
            label="Câu - Các từ nối âm bằng dấu _"
            placeholder="They will make their_own decisions"
            rules="required"
            name="sentence"
          />
        </validation-observer>
...
export default {
  name: 'SpeakingLinkingSoundInlineModal',
  components: {
