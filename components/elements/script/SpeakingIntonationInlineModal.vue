<template>
  <b-modal
    ...
    cancel-title="Đóng"
    ok-title="Đồng ý"
    title="Speaking intonation inline"
    size="xl"
  >
    <b-row>
      <b-col cols="7"
        ><validation-observer ref="observer" class="kt-form">
          ...
          <b-text-input-with-validation
            ...
            :required="true"
            label="Câu - <f></f> Falling, <r></r> Rising, <rf></rf> Rising Falling, <fr></fr> Falling Rising"
            placeholder="What are you <f>doing</f>?"
            rules="required"
            name="sentence"
          />
        </validation-observer>
...
export default {
  name: 'SpeakingIntonationInlineModal',
  components: {
